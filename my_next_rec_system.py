...
class MyNextRecSystem(RecSystem):
    ...
    def __init__(self, trainSet):
        self.trainSet = trainSet  # trainSet to lista krotek (-1 lub 1, user_id, movie_id)
    ...
    def getQueryFloatResult(self, queryTuple):  # queryTuple - krotka z trainSet (przekazywana przez system mierzacy)
        user, movie = queryTuple
        return self.recomendation(user, movie)  # zwrocic prawdopodobienstwo tego ze uzytkownikowi spodoba sie film, moze byc 0 - 1, moze byc 0 - 35.643, wyniki i tak sa sortowane
